...
def generate_resized_image(filename, width, height):
    try:
...
if __name__ == "__main__":
    ...
    filenames_and_sizes = extract_filenames_and_sizes_from_file("link.txt")

    # Обработка каждого имени файла и его размеров
    for filename, width, height in filenames_and_sizes:
        generate_resized_image(filename, width, height)
